from PyQt5.QtWidgets import QApplication, QMainWindow, QLabel, QVBoxLayout, QWidget, QPushButton, QLineEdit, QComboBox, \
 \
    QHBoxLayout, QFileDialog, QAction, QColorDialog, QSizePolicy
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.combo_box_position.setToolTip("Позиция")
    ...
    def save_image(self):
        ...
        file_path, _ = file_dialog.getSaveFileName(self, "Сохранить изображение", "", "Изображения (*.png *.xpm *.jpg)")
